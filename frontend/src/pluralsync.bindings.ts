...
export type Fronter = { fronter_id: string; name: string; pronouns: string | null; avatar_url: string; vrchat_status_name: string | null; pluralkit_id: string | null; start_time: string; privacy_buckets: string[] };
