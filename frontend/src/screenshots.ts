...
const screenshotModules = import.meta.glob<{ default: string }>('../screenshots/*.{png,jpg,jpeg,gif,webp,svg}', { eager: true })
...
if (screenshots.length === 0) {
  throw new Error('Screenshots directory is empty - at least one screenshot is required for the About page')
}
