...
pub static PROM_METRICS: sync::LazyLock<rocket_prometheus::PrometheusMetrics> =
    sync::LazyLock::new(|| {
        ...
        register_metrics!(
            ...
            plurality::PLURALKIT_API_RATELIMIT_REMAINING,
            plurality::PLURALKIT_WEBHOOK_REQUESTS_TOTAL,
            plurality::PLURALKIT_WEBHOOK_VALIDATION_FAILURES_TOTAL,
            plurality::PLURALKIT_WEBHOOK_RELEVANT_EVENTS_TOTAL,
            plurality::PLURALKIT_WEBHOOK_PING_EVENTS_TOTAL,
            plurality::PLURALKIT_WEBHOOK_FETCH_TRIGGERED_TOTAL,
            PLURALSYNC_USER_CONFIG_FEATURE,
            SHOULDNT_HAPPEN_BUT_IT_DID,
            PASSWORD_RESET_REQUESTS_TOTAL,
            PASSWORD_RESET_SUCCESS_TOTAL,
