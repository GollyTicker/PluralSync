...
async fn run_webserver(setup: setup::ApplicationSetup) -> Result<()> {
    let _ = rocket::build()
        ...
        .mount(
            "/",
            routes![
                users::auth_endpoints::post_api_user_register,
                users::auth_endpoints::post_api_user_login,
                users::user_endpoints::get_api_user_info,
                users::auth_endpoints::post_api_user_email_verify,
                users::user_endpoints::post_api_user_email_change,
                users::user_endpoints::delete_api_user,
                users::config_api::get_api_user_config,
                users::config_api::post_api_user_config,
                users::config_api::get_api_config_defaults,
                users::auth_endpoints::post_api_auth_forgot_password,
                users::auth_endpoints::post_api_auth_reset_password,
